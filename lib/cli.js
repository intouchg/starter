...
const createNewProject = async () => {
	...
	if (!templateName) templateName = (await promptForTemplateName()).templateName

	validateTemplateName(templateName)

	console.log(`INFO: Creating new project ${chalk.cyan(projectName)} with template ${chalk.cyan(templateName)} on branch ${chalk.cyan(branch)}`)
